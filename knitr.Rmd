...
```{r echo=FALSE, steps_perinterval, fig.width=8, fig.height=4}
...
labs(title="Figure 4", x="Interval no.", y="Mean number of steps per interval during the week")
...
labs(title="Figure 5", x="Interval no.", y="Mean number of steps per interval during the week-end")
